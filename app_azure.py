...
connection_string = "https://ksforecasting.blob.core.windows.net/kstalep?sp=rl&st=2024-03-30T07:38:05Z&se=2024-05-28T15:38:05Z&spr=https&sv=2022-11-02&sr=c&sig=d2wRRYdmA8ou9hX6Prb8U%2FhkEDomh2r22LXD52FUxUk%3D"
blob_service_client = BlobServiceClient.from_connection_string(connection_string)

container_name = "kstalep"
container_client = blob_service_client.get_container_client(container_name)

# Panel eklentilerini aktive et
...
# Uygulamanın şablonunu oluştur ve main_area'yı ana içerik olarak ekle
